    ...
    <div class="wrapper">
        <div class="inner-wrapper">
            ...
            <div class="main">
                ...
                <div class="detail-1">
                    <div>Nim<p class="colon">:</p><p class="data">{{ $report->reservation->patient->nim }}</p></div>
                    <div>Nama<p class="colon">:</p><p class="data">{{ $report->reservation->patient->name }}</p></div>
                    <div>Tanggal Lahir <p class="colon">:</p><p class="data">{{ $report->reservation->patient->tanggal_lahir }}</p></div>
                    <div>Jenis Kelamin <p class="colon">:</p><p class="data">{{ $report->reservation->patient->jenis_kelamin }}</p></div>
                    <div>Alamat <p class="colon">:</p><p class="data">{{ $report->reservation->patient->alamat }}</p></div>
                </div>
                ...
                <div class="detail-2">
                    <div>Berat Badan<p class="colon">:</p><p class="data">{{ $report->berat_badan }} kg</p></div>
                    <div>Tinggi Badan<p class="colon">:</p><p class="data">{{ $report->tinggi_badan }} cm</p></div>
                    <div>Suhu Badan<p class="colon">:</p><p class="data">{{ $report->suhu_badan }}&#176; celcius</p></div>
                    <div>Keluhan <p class="colon">:</p><p class="data">{{ $report->keluhan }}</p></div>
                    <div>Diagnosa <p class="colon">:</p><p class="data">{{ $report->diagnosa }}</p></div>
                </div>
