                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a class="flex justify-start items-center rounded-xl space-x-3 py-4 px-4 transition duration-150 hover:bg-gray-100 hover:transition bg-gradient-to-r from-[#ED1C24]/90 via-[#ED1C24]/90 to-[#ED1C24]/50 text-white"
                                    href="/admin-dashboard">
                                    <img class="w-[25px] z-10 invert" src="/img/antrian-sidebar-icon.png"
                                        alt="logo" />
                                    <p class="z-10 text-sm" class="font-medium">
                                        Antrian Pemeriksaan
                                    </p>
            ...
            <div class="h-full flex flex-col">
                <header class="flex mb-4 items-center justify-between">
                    <div class="flex justify-start items-center space-x-4">
                        ...
                        <h1 class="font-semibold text-xl">Antrian Pemeriksaan</h1>
                    </div>
                ...
                <div class="bg-white w-full rounded-xl flex-1 p-6">
                    <h2 class="text-lg font-semibold mb-8">Kelola Antrian Pemeriksaan</h2>
                    <div class="flex justify-between mb-6">
                        ...
                        <div
                            class="flex w-40 justify-between items-center py-1 px-2 text-sm rounded-lg border-2 border-gray-300 focus:border-gray-600">
                            <p>Poli Umum</p>
