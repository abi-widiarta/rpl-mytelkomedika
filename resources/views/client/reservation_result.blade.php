                    ...
                    <div class="flex flex-col justify-start flex-1">
                        ...
                        <div class="flex flex-col mb-5 space-y-2">
                            <div class="flex items-center space-x-2">
                                ...
                                <p class="text-sm font-semibold text-gray-500">{{ \Carbon\Carbon::parse($pemeriksaan->tanggal)->locale('id')->isoFormat('dddd') }}, {{ \Carbon\Carbon::parse($pemeriksaan->tanggal)->format('d-m-Y') }}</p>
                            </div>
