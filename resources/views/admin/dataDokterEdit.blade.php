                      ...
                      <div class="w-full">
                        ...
                        <div class="mb-6">
                          ...
                          <select name="poli" id="poli" class="bg-white disabled:bg-slate-100 disabled:text-gray-500 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-primary/50">
                            ...
                            <option {{ $doctor->spesialisasi == "umum" ? 'selected' : ''}} value="umum">Umum</option>
                            <option {{ $doctor->spesialisasi == "mata" ? 'selected' : ''}} value="mata">Mata</option>
                            <option {{ $doctor->spesialisasi == "gigi" ? 'selected' : ''}} value="gigi">Gigi</option>
                          </select>
                        </div>
                        <div class="mb-6">
                          <label
