                ...
                @foreach ($doctors as $doctor)
                    <div onclick="location.href='/lakukan-reservasi/detail/{{ $doctor->username }}';" class="flex justify-start py-6 pl-6 pr-10 space-x-4 transition-all duration-150 bg-white shadow-lg hover:cursor-pointer hover:pointer hover:-translate-y-1 rounded-xl shadow-gray-100">
                        <div class="space-y-2 text-center">
                            <img class="object-cover h-56 rounded-lg w-44" src="{{ $doctor->jenis_kelamin == 'L' ? '/uploads/img/stephenstrange.jpg' : '/uploads/img/poetri.jpg' }}" alt="doctor-1" />
                        </div>
                        ...
                        <div class="flex flex-col justify-start flex-1">
                            ...
                            <div class="flex flex-col mb-4 space-y-2">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <p class="text-sm font-medium text-gray-500">{{ $doctor->total_pasien }} patients</p>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#DCFCE7]">
                            ...
                            {{-- @if ($doctor->spesialisasi == 'umum')
                                <div class="flex flex-col mb-4 space-y-2">
                                    <div class="flex items-center space-x-2">
                                        <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#FFE8E8]">
                                            <img src="/img/poli-red.png" alt="">
                                        </div>
                                        <p class="text-sm font-medium text-gray-500">Poli {{ Str::ucfirst($doctor->spesialisasi) }}</p>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#FFE8E8]">
                                            <img src="/img/patient-red.png" alt="">
                                        </div>
                                        <p class="text-sm font-medium text-gray-500">270 patients</p>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#FFE8E8]">
                                            <img src="/img/review-red.png" alt="">
                                        </div>
                            ...
                            @endif --}}
{{-- 
                            @if ($doctor->spesialisasi == 'mata')
                                <div class="flex flex-col mb-4 space-y-2">
                                    <div class="flex items-center space-x-2">
                                        <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#E8F8FF]">
                                            <img src="/img/poli-blue.png" alt="">
                                        </div>
                                        <p class="text-sm font-medium text-gray-500">Poli {{ Str::ucfirst($doctor->spesialisasi) }}</p>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#E8F8FF]">
                                            <img src="/img/patient-blue.png" alt="">
                                        </div>
                                        <p class="text-sm font-medium text-gray-500">270 patients</p>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="flex justify-center items-center w-7 rounded-full aspect-square bg-[#E8F8FF]">
                                            <img src="/img/review-blue.png" alt="">
                                        </div>
                                        <p class="text-sm font-medium text-gray-500">60+ reviews</p>
                                    </div>
                                </div>
